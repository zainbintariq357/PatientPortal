		...
		<>
			<section className='flex flex-col bg-white gap-4 p-4 rounded'>
				<div className='flex justify-between'>
					...
					<button className='text-[var(--color-blue)] text-sm'>View All</button>
				</div>
				<div className='flex flex-col'>
					<article className='flex flex-col md:flex-row justify-between space-y-6'>
						<div className='flex space-x-4 items-center'>
							<div className='bg-[var(--color-gray-50)] py-2 px-2 rounded-lg'>
								<CalenderIcon className="text-[var(--color-brand-blue)]" />
							</div>
							<div className='flex flex-col'>
								<span className='text-base text-[var(--color-black)]'>Office Visit</span>
								<span className='text-[var(--color-blue)]'>General Check-up</span>
							</div>
						</div>
						...
						<div className='flex flex-col pl-10 pb-2 md:pl-0 md:pb-0'>
							...
							<p className='text-red-500 text-base text-[var(--color-appointment-cancel)] font-medium'>Cancel Request</p>
						</div>
					</article>
					...
					<article className='flex flex-col md:flex-row justify-between'>
						<div className='flex space-x-4 items-center'>
							<div className='bg-[var(--color-gray-50)] py-2 px-2 rounded-lg'>
								<CalenderIcon className="text-[var(--color-text-green)]" />
							</div>
							<div className='flex flex-col'>
								<span>Tele Visit</span>
								<span className='text-[var(--color-blue)]'>Back Pain</span>
							</div>
						</div>
			...
			<div className='flex flex-col lg:flex-row justify-between gap-4 space-x-4 p-2'>
				<div className='flex w-full lg:w-1/2 flex-col items-start bg-white gap-1 p-4 rounded'>
					<div className='inline-flex p-3 rounded bg-[var(--color-gray-50)] rounded-full'>
						<AppointmentIcon className="text-[var(--color-text-green)]" />
					</div>
					<span className='text-base font-medium text-[var(--color-black)]'>Request Appointment</span>
					<span className='text-sm text-[var(--color-gray-text)]'>Schedule your next appointment</span>
				</div>

				<div className='flex w-full lg:w-1/2 flex-col items-start bg-white gap-1 p-4 rounded'>
					<div className='inline-flex bg-[var(--color-light-blue)] p-3  rounded-full'>
						<CommentFillIcon className="text-[var(--color-blue)]" />
					</div>
					<span className='text-base font-medium text-[var(--color-black)]'>Message Provider</span>
					<span className='text-sm text-[var(--color-gray-text)]'>Get in touch with your provider</span>
				</div>
			</div>
		</>
	)
