...
const Login = () => {
    ...
    <>
      {view == 'new' ? (
        <NewPatientRegistration onBack={() => setView('login')} />
      ) : view == 'existing' ? (
        <ExistingPatientRegistration onBack={() => setView('login')} />
      ) : (
        <div className="min-h-screen flex flex-col lg:flex-row p-4 lg:p-5 gap-6">
          ...
          <div className="w-full lg:w-1/3 flex flex-col">
            ...
            <div className="flex flex-col mt-14">
              ...
              <p className="text-[#70757A] text-base pt-2">
                {' '}
              ...
              <form
                ...
                <p className="text-right text-[#2563EB] text-sm mt-3 cursor-pointer font-normal">
                  {' '}
                  Forgot Password?{' '}
                </p>
                ...
                <button
                  type="submit"
                  className="w-full h-12 rounded-full mt-2 bg-primary text-white mt-6 cursor-pointer">
                  {' '}
                  Login{' '}
                </button>
              </form>
